Qualtrics.SurveyEngine.addOnload(function() {
    ...
    if (["Populism_A", "Populism_B"].includes(candidate_1_1)) {
        candidate_1_2 = sample(remove(all_statements, ["Populism_A", "Populism_B"]));
    } else if (["Rights_A", "Rights_B"].includes(candidate_1_1)) {
        candidate_1_2 = sample(remove(all_statements, ["Rights_A", "Rights_B"]));
    } else if (["Market_A", "Market_B"].includes(candidate_1_1)) {
        candidate_1_2 = sample(remove(all_statements, ["Market_A", "Market_B"]));
    } else {
        candidate_1_2 = sample(remove(all_statements, ["Tradeoffs_A", "Tradeoffs_B"]));
    }
    ...
    if (["Populism_A", "Populism_B"].includes(candidate_2_1)) {
        candidate_2_2 = sample(remove(all_statements_updated, ["Populism_A", "Populism_B"]));
    } else if (["Rights_A", "Rights_B"].includes(candidate_2_1)) {
        candidate_2_2 = sample(remove(all_statements_updated, ["Rights_A", "Rights_B"]));
    } else if (["Market_A", "Market_B"].includes(candidate_2_1)) {
        candidate_2_2 = sample(remove(all_statements_updated, ["Market_A", "Market_B"]));
    } else {
        candidate_2_2 = sample(remove(all_statements_updated, ["Tradeoffs_A", "Tradeoffs_B"]));
    }
    ...
    if (["Populism_A", "Populism_B"].includes(candidate_3_1)) {
        candidate_3_2 = sample(remove(all_statements_updated, ["Populism_A", "Populism_B"]));
    } else if (["Rights_A", "Rights_B"].includes(candidate_3_1)) {
        candidate_3_2 = sample(remove(all_statements_updated, ["Rights_A", "Rights_B"]));
    } else if (["Market_A", "Market_B"].includes(candidate_3_1)) {
        candidate_3_2 = sample(remove(all_statements_updated, ["Market_A", "Market_B"]));
    } else {
        candidate_3_2 = sample(remove(all_statements_updated, ["Tradeoffs_A", "Tradeoffs_B"]));
    }
    all_statements_updated = remove(all_statements_updated, [candidate_3_1, candidate_3_2]);

    // Pair 4 -- Now, all_statements_updated should have only two left, one from each theme
